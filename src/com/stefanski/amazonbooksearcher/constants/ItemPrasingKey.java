package com.stefanski.amazonbooksearcher.constants;
...
public class ItemPrasingKey {
	...
	public static final String[] parsingKey = { AUTHORS_START, AUTHORS_END, PUBLISHER_AND_PUBLICATION_YEAR_START,
			PUBLISHER_AND_PUBLICATION_YEAR_END, ISBN_START, ISBN_END, AMAZON_RATING_START, AMAZON_RATING_END };
